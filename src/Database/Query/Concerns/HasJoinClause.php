...
{
    /**
     * @var list<array{type: string, table: string, clause: JoinClause}>
     */
    private array $joins = [];
    ...
    private function addJoin(string $type, string $table, Closure|string $first, ?string $operator, ?string $second): static
    {
